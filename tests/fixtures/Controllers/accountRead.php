...
return [
	...
	'readRelationshipsEmails'       => [
		'/v1/me/relationships/' . Schemas\Accounts\AccountSchema::RELATIONSHIPS_EMAILS,
		'Bearer ' . ADMINISTRATOR_TOKEN,
		StatusCodeInterface::STATUS_OK,
		__DIR__ . '/responses/account/account.relationship.emails.json',
	],
	'readRelationshipsIdentities'   => [
		'/v1/me/relationships/' . Schemas\Accounts\AccountSchema::RELATIONSHIPS_IDENTITIES,
		'Bearer ' . ADMINISTRATOR_TOKEN,
		StatusCodeInterface::STATUS_OK,
		__DIR__ . '/responses/account/account.relationship.identities.json',
	],
	'readRelationshipsRoles'        => [
		'/v1/me/relationships/' . Schemas\Accounts\AccountSchema::RELATIONSHIPS_ROLES,
		'Bearer ' . ADMINISTRATOR_TOKEN,
		StatusCodeInterface::STATUS_OK,
