INSERT IGNORE INTO `fb_accounts` (`account_id`, `account_state`, `account_last_visit`, `params`, `created_at`, `updated_at`, `account_request_hash`)
VALUES (_binary 0x5E79EFBFBD0D5B7C46EFBFBDEFBFBD34, 'active', '2019-11-07 22:30:56', '{"datetime": {"zone": "Europe/Prague", "format": {"date": "DD.MM.YYYY", "time": "HH:mm"}, "week_start": 1}}', '2017-01-03 11:30:00', '2017-01-03 11:30:00', 'NGZqMmVxdnhubjJpIyMxNTc0NDUwNDAz'),
       ...
       (_binary 0xFAE8D7817E2C43189C8543BA637D14C5, 'approvalWaiting', '2019-05-29 07:38:24', '{"datetime": {"zone": "Europe/Prague", "format": {"date": "DD.MM.YYYY", "time": "HH:mm"}, "week_start": 1}}', '2017-01-04 12:30:00', '2017-01-04 12:30:00', 'YjRqZXFoZGw1Z3ZzIyMxNTc0MjA3NDQ1'),
       (_binary 0xFD23CCB48D874EB394DA638AB4E10AE3, 'notActivated', '2019-05-29 07:38:24', '{"datetime": {"zone": "Europe/Prague", "format": {"date": "DD.MM.YYYY", "time": "HH:mm"}, "week_start": 1}}', '2017-01-04 12:30:00', '2017-01-04 12:30:00', 'YjRqZXFoZGw1Z3ZzIyMxNTc0MjA3NDQ1'),
...
INSERT IGNORE INTO `fb_accounts_details` (`detail_id`, `account_id`, `detail_first_name`, `detail_last_name`, `detail_middle_name`, `created_at`, `updated_at`)
...
INSERT IGNORE INTO `fb_emails` (`email_id`, `account_id`, `email_address`, `email_default`, `email_verified`, `email_verification_hash`, `email_verification_created`, `email_verification_completed`, `email_visibility`, `created_at`, `updated_at`)
...
INSERT IGNORE INTO `fb_identities` (`identity_id`, `account_id`, `identity_uid`, `identity_state`, `created_at`, `updated_at`, `identity_token`, `params`)
