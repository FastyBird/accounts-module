INSERT
IGNORE INTO `fb_accounts` (`account_id`, `account_state`, `account_last_visit`, `params`, `created_at`, `updated_at`, `account_request_hash`)
...
INSERT
IGNORE INTO `fb_accounts_details` (`detail_id`, `account_id`, `detail_first_name`, `detail_last_name`, `detail_middle_name`, `created_at`, `updated_at`)
...
INSERT
IGNORE INTO `fb_emails` (`email_id`, `account_id`, `email_address`, `email_default`, `email_verified`, `email_verification_hash`, `email_verification_created`, `email_verification_completed`, `email_visibility`, `created_at`, `updated_at`)
...
INSERT
IGNORE INTO `fb_identities` (`identity_id`, `account_id`, `identity_uid`, `identity_state`, `created_at`, `updated_at`, `identity_token`, `params`)
...
INSERT
IGNORE INTO `fb_accounts_roles` (`role_id`, `account_id`)
